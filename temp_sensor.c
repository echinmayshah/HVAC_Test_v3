...
uint16_t MCU_TempSensorCalc(uint16_t ADCResult)
{
	...
	else if(ADCResult <= 2830 && ADCResult > 2540)	//90 to 99
	{
		divisor = 13.5444f;
	}
	else if(ADCResult <= 2540 && ADCResult > 2242)	//100 to 109
	{
		divisor = 15.09f;
	}
/*3th commit_in_dev_0_0	else if(ADCResult <= 2242 && ADCResult > 1947)	//110 to 119
	{
		divisor = 16.427272;
	}	*/
/*2th commit_in_dev_0_0	else if(ADCResult <= 1947 && ADCResult > 1669)	//120 and above
	{
		divisor = 18.248f;
	}	*/
